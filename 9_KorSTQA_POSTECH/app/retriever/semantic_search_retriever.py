...
class SemanticRetriever(object):
    def __init__(self, passages_list:List, pretrained_embedding_model_name):
    ...
    def query_index(self, query:str, top_k:int):
        ...
        matched_documents = [self.corpus[idx] for idx in top_results[1]]
...
def main(args):
    ...
    retriever = SemanticRetriever(mypassage_list, args.pretrained_embedding_model_name)
